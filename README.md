...
**VisionXI** is een Computer Vision-applicatie voor het automatisch detecteren en volgen van voetballers in wedstrijd- en trainingsvideo's.
...
### 4. Object Tracking
Een tracking-algoritme wordt gebruikt om spelers over meerdere frames te volgen.
...
Tijdens de ontwikkeling zijn enkele beperkingen vastgesteld:
...
### Heatmaps
Visualiseren waar spelers zich tijdens een wedstrijd of training het meest bevinden.
...
**Projectnaam:**  
*Player Detection & Performance Analysis Using Computer Vision for Football Development in Suriname*

VisionXI is ontwikkeld als onderdeel van een ICT/Data Science-project met focus op Computer Vision en voetbalanalyse.

---

## Disclaimer

VisionXI is ontwikkeld als een onderzoeks- en prototypeproject.

De resultaten van automatische detectie en analyse kunnen fouten bevatten. De gegenereerde gegevens moeten daarom worden beschouwd als **ondersteunende informatie** en niet als de enige basis voor beslissingen over spelers of teams.
...
Door toekomstige functies zoals **ball tracking, heatmaps, uitgebreidere performance metrics en automatische talentanalyse** toe te voegen, kan het systeem verder worden ontwikkeld tot een uitgebreider hulpmiddel voor coaches, clubs en voetbalorganisaties.
